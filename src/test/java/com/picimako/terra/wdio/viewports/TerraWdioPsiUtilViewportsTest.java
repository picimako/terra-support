...
public class TerraWdioPsiUtilViewportsTest extends BasePlatformTestCase {
    ...
    public void testViewportsSet() {
        ...
        var element = PsiTreeUtil.getParentOfType(myFixture.getFile().findElementAt(myFixture.getCaretOffset()), JSExpressionStatement.class);
    ...
    public void testGetsViewports() {
        ...
        var viewports = TerraWdioPsiUtil.getViewports(element);

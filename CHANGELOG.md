...
is included in the dependencies of the project's root package.json. `terra-functional-testing` takes precedence.
...
- Updated context string resolution to include the theme in the context string. This affects the reference suggestions and the Diff and Reference/Latest previews.
- Unused screenshot finding logic is updated as well.

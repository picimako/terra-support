...
Terra.describeViewports('Test', ['tiny', 'small', 'medium', 'large', 'huge', 'enormous'], () => {
    describe('A describe block', () => {
        it('no-highlight cases for element', () => {
            ...
            Terra.validates.element('test case', { misMatchTolerance: 50 });
            Terra.validates.element('test case', { misMatchTolerance: 60, axeRules: { } });
        ...
        it('no-highlight cases for screenshot', () => {
            ...
            Terra.validates.screenshot('test case', { misMatchTolerance: 50 });
            Terra.validates.screenshot('test case', { misMatchTolerance: 60, axeRules: { } });
    ...
    Terra.it.validatesElement('test case', { misMatchTolerance: 50 });
    Terra.it.validatesElement('test case', { misMatchTolerance: 60, axeRules: { } });
    ...
    Terra.it.matchesScreenshot('test case', { misMatchTolerance: 50 });
    Terra.it.matchesScreenshot('test case', { misMatchTolerance: 60, axeRules: { } });
